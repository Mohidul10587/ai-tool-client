...
export const metadata: Metadata = {
  title: "DMCA Policy",
  description:
    "AI Directory DMCA policy — how to report copyright infringement and file counter-notices.",
};
    ...
    <div className="max-w-7xl mx-auto px-4 py-16 space-y-8 text-sm text-foreground">
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          AI Directory respects the intellectual property rights of others and
          expects users of the platform to do the same. In accordance with the
          Digital Millennium Copyright Act (DMCA), we will respond promptly to
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          If you believe that content on AI Directory infringes your copyright,
          please send a written notice to our designated DMCA agent containing:
        </p>
        <ul className="text-muted-foreground leading-relaxed list-disc list-inside space-y-2">
          ...
          <li>
            The URL or other specific location on AI Directory where the
            allegedly infringing content is located.
          </li>
          <li>
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          If you believe that content you submitted was removed by mistake or
          misidentification, you may file a counter-notice. The counter-notice
          must include: your name, address, phone number, and email;
          identification of the removed content and its location before removal;
          a statement under penalty of perjury that you have a good-faith belief
          the content was removed by mistake; and your consent to jurisdiction
      ...
      <section className="space-y-3">
        ...
        <p className="text-muted-foreground leading-relaxed">
          We reserve the right to disable and/or terminate the accounts of users
